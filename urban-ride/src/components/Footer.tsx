    ...
    <footer className="bg-white text-black pt-32 pb-16 px-6 md:px-12 border-t border-gray-100">
      <div className="max-w-[1440px] mx-auto">
        ...
        >
          ...
          <div>
            ...
            <ul className="space-y-4 text-[14px] font-medium">
              ...
              <li><a href="#" className="hover:opacity-50 transition-opacity">Huye</a></li>
            </ul>
          </div>
        ...
        <motion.div 
          ...
          viewport={{ once: true }}
          className="pt-12 border-t border-gray-100 flex flex-col md:flex-row justify-between items-center gap-8"
        >
          <p className="text-[11px] font-medium opacity-30 tracking-wide">
            © 2026 URBAN RIDE. ALL RIGHTS RESERVED.
          </p>
          <div className="flex gap-8">
            <motion.a whileHover={{ y: -2 }} href="#" className="hover:opacity-50 transition-opacity"><Facebook size={18} /></motion.a>
            <motion.a whileHover={{ y: -2 }} href="#" className="hover:opacity-50 transition-opacity"><Twitter size={18} /></motion.a>
            <motion.a whileHover={{ y: -2 }} href="#" className="hover:opacity-50 transition-opacity"><Instagram size={18} /></motion.a>
            <motion.a whileHover={{ y: -2 }} href="#" className="hover:opacity-50 transition-opacity"><Youtube size={18} /></motion.a>
          </div>
        </motion.div>
      </div>
    </footer>
